    ...
    return (
      <div className="p-3 sm:p-7 overflow-y-auto">
        <div className="text-center">
          ...
          <div className="mt-5 sm:mt-6 px-1 sm:px-4 py-3 sm:py-4 bg-gray-100 dark:bg-muted rounded-md">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="col-span-2 sm:col-span-1">
                <p className="text-xs text-gray-500 dark:text-muted-foreground">Product</p>
                <span className="text-xs sm:text-sm font-semibold text-gray-800 dark:text-neutral-200 line-clamp-2">{itemMetadata.title}</span>
              </div>
              
              <div>
                <p className="text-xs text-gray-500 dark:text-muted-foreground">Quantity</p>
                <span className="text-xs sm:text-sm font-semibold text-gray-800 dark:text-neutral-200">{quantity}</span>
              </div>

              <div>
                <p className="text-xs text-gray-500 dark:text-muted-foreground">Price</p>
                <span className="text-xs sm:text-sm font-semibold text-gray-800 dark:text-neutral-200">{formattedTotalPrice}</span>
              </div>

              <div className="sm:col-span-4">
                <div className="bg-white dark:bg-muted border border-gray-200 dark:border-border px-3 py-3 rounded-md">
                  <div className="flex items-center gap-x-3">
                    <div className="flex-shrink-0 flex justify-center items-center size-10 sm:size-12 border border-gray-200 dark:border-border rounded-full bg-gray-100 dark:bg-muted">
                      <HandCoins className="size-5 text-gray-600 dark:text-muted-foreground" />
                    </div>

                    <div>
                      <p className="text-xs sm:text-sm font-medium text-gray-800 dark:text-neutral-200">
                        Payment
                      </p>
          ...
          <div className="mt-5 flex justify-end">
            <button
              type="button"
              className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 dark:bg-primary text-white hover:bg-blue-700 dark:hover:bg-primary/90 disabled:opacity-50 disabled:pointer-events-none"
              onClick={handleWrite}
            >
              Confirm & Pay
            </button>
  ...
  const SendingModal = () => {
    return (
      <div className="p-4 sm:p-10 overflow-y-auto">
        <div className="text-center">
          <span className="mx-auto flex justify-center items-center size-[50px] sm:size-[62px] rounded-full border border-gray-200 bg-white text-gray-700 shadow-sm dark:bg-muted dark:border-border dark:text-neutral-300">
            <div className="animate-spin size-5 sm:size-6 border-t-2 border-blue-600 dark:border-primary rounded-full" />
          </span>

          <h3
            className="mt-2 sm:mt-6 text-base sm:text-lg font-semibold text-gray-800 dark:text-neutral-200"
          >
            Processing Payment
          </h3>
          <p className="text-xs sm:text-sm text-gray-500 dark:text-neutral-500">
          ...
          <div className="mt-4 sm:mt-8 flex justify-center gap-x-2">
            <div className="py-1 sm:py-2 px-3 sm:px-4 inline-flex justify-center items-center gap-x-2 text-xs font-medium rounded-lg cursor-default bg-gray-100 text-gray-500 dark:bg-muted dark:text-neutral-400">
              <svg
                className="animate-spin size-4 text-gray-500 dark:text-neutral-400"
    ...
    return (
      <div className="p-4 sm:p-10 overflow-y-auto">
        <div className="text-center">
          ...
          <h3 className="mt-2 sm:mt-6 text-base sm:text-lg font-semibold text-gray-800 dark:text-neutral-200">
            Payment successful
          </h3>
          <p className="text-xs sm:text-sm text-gray-500 dark:text-neutral-500">
          ...
          <div className="mt-5 sm:mt-8">
            <p className="text-xs sm:text-sm text-gray-500 dark:text-neutral-500">
              Transaction hash: <a href={`https://holesky.etherscan.io/tx/${transactionHash}`} className="text-blue-600 dark:text-primary decoration-2 hover:underline font-medium" target="_blank">{transactionHash.slice(0, 10)}...{transactionHash.slice(-10)}</a>
            </p>
          </div>
          ...
          <div className="mt-12 flex justify-end">
            <button
              type="button"
              className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-muted dark:border-border dark:text-neutral-300 dark:hover:bg-muted/80"
              onClick={onClose}
            >
              Close
            </button>
