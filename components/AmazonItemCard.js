  ...
  return (
    <div className="bg-white dark:!bg-gray-800 shadow-md rounded-lg p-4 sm:p-6 relative">
      ...
      <div className="flex flex-col sm:hidden">
        ...
        <p className="text-gray-700 dark:!text-gray-200 text-xs mb-3">{truncateTitle(metadata.description, 80)}</p>
      ...
      <div className="hidden sm:flex sm:items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 dark:!text-gray-200 flex-grow">{metadata.description}</p>
